        ...
        <Modal open={modalShow} onClose={modalClose} disableAutoFocus>
          <div className="absolute top-[20%] left-[30%] w-[40vw] h-[25vw] bg-white rounded-2xl">
            <div className="flex justify-between items-center px-3 py-3 border-b border-gray-200 ">
              ...
              <button onClick={modalClose} className="hover:bg-gray-100 bg-white p-2 rounded-full">
                <svg
    ...
    <div className="  bg-white w-[40vw] h-28 rounded-lg px-3 py-3 ">
      <div className="flex space-x-2">
        <img
          ...
          src={avatar}
        ></img>
        <button onClick={ modalOpen } className=" w-[30vw] flex hover:bg-gray-200 items-center text-gray-500 h-12 border border-gray-300 rounded-3xl text-start px-3 py-5">
          Start a post
        </button>
      </div>
